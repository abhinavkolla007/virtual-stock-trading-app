...
public class RegistrationController {
    ...
    //     } catch (com.nikolagrujic.tradingsimulator.exception.InvalidTokenException e) {
    //         return ResponseEntity.badRequest().body(java.util.Map.of("errorMessage", "Invalid token"));
    //     } catch (com.nikolagrujic.tradingsimulator.exception.ExpiredTokenException e) {
    //         return ResponseEntity.badRequest().body(java.util.Map.of("errorMessage", "Token expired"));
    //     }
    }